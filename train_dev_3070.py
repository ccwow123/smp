...
class Trainer():
    ...
    def dataload_VOC(self):
        # 训练集
        x_train_dir = os.path.join(self.dir, 'VOC2007/JPEGImages')
        y_train_dir = os.path.join(self.dir, 'VOC2007/SegmentationClass')

        # 验证集
        x_valid_dir = os.path.join(self.dir, 'VOC2007/JPEGImages')
        y_valid_dir = os.path.join(self.dir, 'VOC2007/SegmentationClass')
...
def parse_args():
    ...
    parser.add_argument("--data-path", default=r'xxxxx', help="VOCdevkit 路径")
